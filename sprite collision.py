...
background_image = pygame.transform.scale(pygame.image.load("flappybird.png"),
...
sprite1.rect.x = random.randint( 0, SCREEN_HEIGHT - sprite1.rect.height)
